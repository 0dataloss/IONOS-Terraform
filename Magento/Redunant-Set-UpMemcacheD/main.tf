...
///////////////////////////////////////////////////////////
// Network PRIVATE WEB2MEM
///////////////////////////////////////////////////////////

resource "ionoscloud_lan" "WEB2MEM_lan" {
  datacenter_id = ionoscloud_datacenter.Customer_DC.id
  public        = false
  name          = "WEB2MEM_lan"
}
...
resource "ionoscloud_server" "memcached01" {
  name              = "memcached01"
  datacenter_id     = ionoscloud_datacenter.Customer_DC.id
  cores             = 1
  ram               = 2048
...
resource "ionoscloud_server" "memcached02" {
  name              = "memcached02"
  datacenter_id     = ionoscloud_datacenter.Customer_DC.id
  cores             = 1
  ram               = 2048
...
// Memcache Firewall
//////////////////////////////////////////
resource "ionoscloud_firewall" "memcached01_public" {
  datacenter_id    = "${ionoscloud_datacenter.Customer_DC.id}"
  server_id        = "${ionoscloud_server.memcached01.id}"
  nic_id           = "${ionoscloud_server.memcached01.primary_nic}"
  protocol         = "TCP"
  port_range_start = 22
  port_range_end   = 22
  source_ip        = var.origin_IP01
}
resource "ionoscloud_firewall" "memcachede02_public" {
  datacenter_id    = "${ionoscloud_datacenter.Customer_DC.id}"
  server_id        = "${ionoscloud_server.memcached02.id}"
  nic_id           = "${ionoscloud_server.memcached02.primary_nic}"
  protocol         = "TCP"
  port_range_start = 22
  port_range_end   = 22
  source_ip        = var.origin_IP01
...
resource "ionoscloud_nic" "memcached01_web2mem_nic" {
  datacenter_id = ionoscloud_datacenter.Customer_DC.id
  server_id     = ionoscloud_server.memcached01.id
  lan           = ionoscloud_lan.WEB2MEM_lan.id
  name          = "PrivateWEB2MEM_NIC"
  dhcp          = true
}
resource "ionoscloud_nic" "memcached02_web2mem_nic" {
  datacenter_id = ionoscloud_datacenter.Customer_DC.id
  server_id     = ionoscloud_server.memcached02.id
  lan           = ionoscloud_lan.WEB2MEM_lan.id
  name          = "PrivateWEB2MEM_NIC"
...
resource "ionoscloud_nic" "webserver01_web2mem_nic" {
  datacenter_id = ionoscloud_datacenter.Customer_DC.id
  server_id     = ionoscloud_server.webserver01.id
  lan           = ionoscloud_lan.WEB2MEM_lan.id
  name          = "PrivateWEB2MEM_NIC"
...
resource "ionoscloud_nic" "webserverd02_web2mem_nic" {
  datacenter_id = ionoscloud_datacenter.Customer_DC.id
  server_id     = ionoscloud_server.webserver02.id
  lan           = ionoscloud_lan.WEB2MEM_lan.id
  name          = "PrivateWEB2MEM_NIC"
